...
# --- 1. ZAKŁADKA: ZARZĄDZANIE SKŁADEM ---
...
def trener_sklad():
    ...
    <div class="container mt-4">
        ...
        <a href="{{ url_for('trener_bp.trener_analiza') }}" class="btn btn-info mt-4">Przejdź do Analizy Rywala</a>
    </div>
    """
    return render_template_string(NAV_HTML + CONTENT_HTML + FOOTER_HTML, team=my_team)


# --- 2. ZAKŁADKA: ANALIZA PRZECIWNIKA ---
...
def trener_analiza():
    ...
    if request.method == 'POST':
        # Pobieramy wpisaną nazwę drużyny (ignoruje wielkość liter dzięki ilike)
        ...
        if not searched_team:
            ...
            # Magia SQL: Szukamy zawodnika z drużyny trenera, który strzelił najwięcej goli przeciwnikowi
    ...
    <div class="container mt-4">
        ...
        <a href="{{ url_for('trener_bp.trener_sklad') }}" class="btn btn-secondary mt-4">Powrót do składu</a>
    </div>
    """
